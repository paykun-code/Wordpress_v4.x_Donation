...
class Payment {
    ...
    private function addLog($message) {
        ...
        //This method code is commented out because the throw statement inside this class will throw an error
        //and the respected catch method will called.
        ...
        if($log == "yes"){
            ...
            $message = $todayFileLog.':'.$time." => " . $message;
